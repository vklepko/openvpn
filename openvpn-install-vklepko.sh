...
LimitNPROC=infinity" > /etc/systemd/system/openvpn-server@server.service.d/disable-limitnproc.conf
	...
	if [[ "$os" = "debian" || "$os" = "ubuntu" ]]; then
		apt-get update
		apt-get install -y openvpn openssl ca-certificates dnsmasq $firewall
	...
	cd /etc/ && mv dnsmasq.conf dnsmasq.conf.original
	echo -e "listen-address=10.8.0.1\nbind-interfaces" > /etc/dnsmasq.conf
	echo -e '#!/bin/sh -e\n#\n#rc.local\n#\n\n/etc/init.d/dnsmasq restart\n\nexit 0' > /etc/rc.local
	chmod +x /etc/rc.local
	/etc/init.d/dnsmasq restart
	echo -e "\n\n127.0.0.1\twww.youtube.com\n127.0.0.1\ttv.youtube.com\n127.0.0.1\tmusic.youtube.com\n127.0.0.1\tm.youtube.com\n127.0.0.1\tgaming.youtube.com\n127.0.0.1\tyoutube.com\n127.0.0.1\tplay.google.com\n127.0.0.1\topen.spotify.com\n127.0.0.1\tspotify.com\n127.0.0.1\tmusic.apple.com\n127.0.0.1\tbeta.music.apple.com\n127.0.0.1\tdeezer.com\n127.0.0.1\twww.deezer.com\n127.0.0.1\tsoundcloud.com\n127.0.0.1\ttidal.com\n127.0.0.1\twww.ivi.ru ivi.ru\n127.0.0.1\twww.film.ru film.ru\n127.0.0.1\tmegogo.net\n127.0.0.1\thd1080.online\n127.0.0.1\tkinokong.org\n127.0.0.1\twww.tiktok.com tiktok.com\n127.0.0.1\twww.facebook.com facebook.com" >> /etc/hosts
	echo "WSGIScriptAlias /openvpn-monitor /var/www/html/openvpn-monitor/openvpn-monitor.py" > /etc/apache2/conf-available/openvpn-monitor.conf
	a2enconf openvpn-monitor && systemctl restart apache2
	cd /var/www/html && git clone https://github.com/furlongm/openvpn-monitor.git
	# Get easy-rsa
